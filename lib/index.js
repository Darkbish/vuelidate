...
var validationGetters = {
  ...
  $errors: function $errors() {
    ...
    var errors = ruleKeys.filter(function (key) {
      return !proxy[key];
    }).map(function (key) {
      return _this3.getRef(key).$params.message;
    });
    return errors;
  }
};
      ...
      proxy: function proxy() {
        ...
        var keyDefs = buildFromKeys(this.keys, function (key) {
          return {
            ...
            configurable: false,
            get: function get() {
              return _this6.getRef(key).proxy;
            }
          };
        });
    ...
    computed: {
      ...
      tracker: function tracker() {
        ...
        return trackBy ? function (key) {
          return '' + getPath(_this8.rootModel, _this8.model[key], trackBy);
        } : function (x) {
          return '' + x;
        };
      },
      children: function children() {
        ...
        return this.keys.map(function (key) {
          ...
          return (0, _vval.h)(Validation, track, {
            ...
            prop: key,
            parentModel: _this9.model,
            model: _this9.model[key],
